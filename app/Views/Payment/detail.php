						...
						<div class="card-body">
							<div class="row">
								<div class="col-sm-6">
									...
									<?php
									$expiryDate = date('Y-m-d H:i:s', strtotime($orders['date_create'] . ' +30 minutes')); // Expiry time
									...
									<?php if ($orders['status'] == 'Pending'): ?>
										...
										<?php if ($orders['payment_type'] == 'QRIS' && ($orders['payment_gateway'] == 'Ayolinx' || $orders['payment_gateway'] == 'ZapxPay') && $currentTime < $expiryDate): ?>
											...
											<div class="pb-4"><b> SCAN QR CODE dibawah ini </b><br>
												...
												<h2 id="timer" style="color:white;font-size:10px;">Berlaku sampai 5:00</h2>
											</div>

										<?php endif ?>

										<?php if (filter_var($orders['payment_code'], FILTER_VALIDATE_URL)): ?>
											<?php if (in_array($orders['payment_type'], array('QRIS'))) : ?>
												<div class="pb-4"><b> SCAN QR CODE dibawah ini </b><br>
...
<script>
	...
	document.getElementById('downloadBtn').addEventListener('click', function () {
        var imgUrl = document.getElementById('qrCodeImage').src;
