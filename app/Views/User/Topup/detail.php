									...
									<div class="card-body">
										<div class="row">
											<div class="col-sm-6">
												...
												<?php
														$expiryDate = date('Y-m-d H:i:s', strtotime($topup['date_create'] . ' +30 minutes')); // Expiry time
												...
												<?php if ($topup['status'] == 'Pending'): ?>
													<?php if ($topup['payment_type'] == 'QRIS' && $currentTime < $expiryDate): ?>
														...
														<div class="pb-4"><b> SCAN QR CODE dibawah ini </b><br>
															<img id="qrCodeImage" src="https://api.qrserver.com/v1/create-qr-code/?data=<?= $topup['payment_code']; ?>&amp;size=250x250" class="mt-3" alt="" title="" />
															<br/>
